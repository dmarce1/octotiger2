...
bool options::process_options(int argc, char *argv[]) {
	...
	("grid_size", po::value<int>(&grid_size)->default_value(256), "size of grid") //
	("help", "produce help message") //
	("max_level", po::value<int>(&max_level)->default_value(0), "size of grid") //
	("problem", po::value<std::string>(&problem)->default_value("blast"), "problem - blast, sod") //
